...
hpc_work_dir = Path(cfg["hpc"]["work_dir"])
views_dir = hpc_work_dir / "labeling_views"
output_dir = hpc_work_dir / "labeling_masks_finetuned"

# Clean old masks so previous experiments do not contaminate the current run
...
model = build_sam3_image_model(bpe_path=bpe_path, load_from_HF=False)
